  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='shangjiashitang'" class="input-group">
			   <div class="label">食堂名称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shitangmingcheng" class="input" type="text" placeholder="食堂名称">
			   </div>
			 </div> -->
			<el-form-item label="食堂名称" class="input" v-if="tableName=='shangjiashitang'">
			  <el-input v-model="ruleForm.shitangmingcheng" autocomplete="off" placeholder="食堂名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjiashitang'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='shangjiashitang'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='shangjiashitang'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="联系人" class="input" v-if="tableName=='shangjiashitang'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='shangjiashitang'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `shangjiashitang` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
