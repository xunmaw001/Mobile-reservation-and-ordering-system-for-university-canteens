<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主食材" prop="zhushicai">
          <el-input v-model="ruleForm.zhushicai" 
              placeholder="主食材" clearable  :readonly="ro.zhushicai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主食材" prop="zhushicai">
              <el-input v-model="ruleForm.zhushicai" 
                placeholder="主食材" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.shitangmingcheng!=''&&json.shitangmingcheng){
                this.ruleForm.shitangmingcheng = json.shitangmingcheng
	    		this.ro.shitangmingcheng = true;
		}
        } else {
	...
	this.ruleForm.meishixiangqing = this.ruleForm.meishixiangqing.replace(reg,'../../../springboot989h0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
